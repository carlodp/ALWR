...
import { Users, FileText, CreditCard, TrendingUp, AlertCircle, BarChart3 } from "lucide-react";
    ...
    <div className="container mx-auto max-w-7xl py-8 px-4 space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card 
          ...
          className="cursor-pointer hover-elevate transition-all md:col-span-2 lg:col-span-1"
        ...
        >
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-reports">
              Analytics
            </div>
            <p className="text-xs text-muted-foreground">
              Revenue & trends
